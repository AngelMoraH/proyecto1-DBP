...
def home():
    ...
    if "user" in session:
        user=session["user"]
    return render_template("home/index.html", user=user) #redirect(url_for("routes.login"))
    ...
    res = dict(
        {
            ...
            "results": [
                ...
                },
                {
                    ...
                    "overview": "A horrifying story of a shaman’s inheritance in the Isan region of Thailand. But the goddess that appears to have taken possession of a family member turns out not be as benevolent as it first appears.",
                    "popularity": 255.896,
                ...
                {
                    "adult": False,
                    "backdrop_path": "/fdiLgQqfFFITMGET31CPdPsfhIW.jpg",
                    "genre_ids": [27],
                    "id": 836225,
                    "original_language": "en",
                ...
                },
                {
                    ...
                    "popularity": 214.894,
                    "poster_path": "/cFOWiYDQ8Nttmt0K6PU38L48wWK.jpg",
